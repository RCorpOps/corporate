  ...
  return (
    <div className="newsletter-bg">
      <div className="container mx-auto pt-24 flex flex-col items-center">
        ...
        <form
          className="relative flex justify-center h-20 mb-32 w-full max-w-3xl pl-0 "
          action=""
        >
          <input
            type="email"
            placeholder="Email address"
            className="relative h-20 mb-32 w-5/6 md:w-full rounded max-w-3xl pl-3 md:pl-11 outline-none text-grey"
          />
